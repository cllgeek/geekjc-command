...
让你删除 `/usr/local/bin/geekjc` 再 `npm link` ， 删除此目录运行 `rm -rf /usr/local/bin/geekjc`

## 发布安装

### 发布到npm中

发布必须注册 [npm](https://www.npmjs.com/) 账号，还有 [github](https://github.com/cllgeek) 账号，具体怎么玩儿问 谷歌大婶吧。在[JSLite.io](http://jslite.io) 中也有教程哦。
